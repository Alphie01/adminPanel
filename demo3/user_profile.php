                ...
                <div class="row layout-spacing">
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="text-center user-info">
                                    <img src=".<?php echo $kullanicicek['kullanici_resim']?>" width="65px" height="65px" alt="avatar">
                                    <p class=""><?php echo $kullanicicek['kullanici_adsoyad'] ?></p>
                                </div>
                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled">
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-coffee"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg> <?php echo $kullanicicek['user_job'] ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg><?php echo $kullanicicek['kullanici_zaman'] ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg><?php echo $kullanicicek['user_country'] ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <a href="mailto:<?php echo $kullanicicek['kullanici_mail'] ?>" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><p><?php echo $kullanicicek['kullanici_mail'] ?></p></a>
                                            </li>
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> <?php echo $kullanicicek['kullanici_gsm'] ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        
                                                            <a href="<?php echo $kullanicicek['kullanici_insta'] ?>"><i class="fab fa-instagram fa-2x" style="color:white;"></i> </a>
                                                        
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <a href="<?php echo $kullanicicek['kullanici_youtube'] ?>"><i class="fab fa-youtube fa-2x" style="color:white;"></i> </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <a href="<?php echo $kullanicicek['kullanici_twitter'] ?>"><i class="fab fa-twitter fa-2x" style="color:white;"></i> </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <a href="<?php echo $kullanicicek['kullanici_twitch'] ?>"><i class="fab fa-twitch fa-2x" style="color:white;"></i> </a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="timeline-alter">
                                    <div class="item-timeline">
                                        ...
                                        <div class="t-text">
                                        <p><?php if($denecek['youtube_salary']!=0) echo $denecek['youtube_salary']; else echo "0"; ?> ₺</p>
                                        ...
                                        <div class="item-timeline">
                                            ...
                                            <div class="t-text">
                                            <p><?php if($denecek['inf_salary']!=0) echo $denecek['inf_salary']; else echo "0"; ?> ₺</p>
                                        ...
                                        <div class="item-timeline">
                                            ...
                                            <div class="t-text">
                                            <p><?php if($denecek['mene_salary']!=0) echo $denecek['mene_salary']; else echo "0"; ?> ₺</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="bio layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <h3 class="">Bio</h3>
                                <p><?php echo $kullanicicek['kullanici_aciklama'] ?></p>
