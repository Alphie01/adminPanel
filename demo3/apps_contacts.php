...
<head>
    ...
    <title>Contact Profile | Creators Menejerlik ve Mail Üyelik Sistemine Hoşgeldiniz </title>
                                ...
                                <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                                    <form class="form-inline my-2 my-lg-0">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control product-search" id="input-search" placeholder="Arama..">
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="items items-header-section">
                                    <div class="item-content">
                                        ...
                                        <div class="user-location">
                                            <h4 style="margin-left: 0;">Şehir</h4>
                                        </div>
...
$todosor=$db->prepare("SELECT * FROM kullanici where kullanici_yetki=5 order by kullanici_id desc LIMIT 25");
                                ...
                                <div class="items">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            ...
                                            <img src=".<?php echo $todocek['kullanici_resim'] ?>" alt="avatar">
                                            <div class="user-meta-info">
                                                <p class="user-name" data-name="<?php echo $todocek['kullanici_adsoyad'] ?>"><?php echo $todocek['kullanici_adsoyad'] ?></p>
                                                <p class="user-work" data-occupation="<?php echo $todocek['user_job'] ?>"><?php echo $todocek['user_job'] ?></p>
                                            </div>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">Email: </p>
                                            <p class="usr-email-addr" style="color:white;" data-email="<?php echo $todocek['kullanici_mail'] ?>"><?php echo $todocek['kullanici_mail'] ?></p>
                                        </div>
                                        <div class="user-location">
                                            <p class="info-title">Location: </p>
                                            <p class="usr-location" style="color:white;" data-location="<?php echo $todocek['user_country'] ?>"><?php echo $todocek['user_country'] ?></p>
                                        </div>
                                        <div class="user-phone">
                                            <p class="info-title">Phone: </p>
                                            <p class="usr-ph-no" style="color:white;" data-phone="<?php echo $todocek['kullanici_gsm'] ?>"><?php echo $todocek['kullanici_gsm'] ?></p>
                                        </div>
                                        <div class="action-btn">
                                            <a href="./another_profile.php?kullanici_id=<?php echo $todocek['kullanici_id'] ?>" style="margin=15px;">
