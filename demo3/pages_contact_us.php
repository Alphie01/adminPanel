...
<head>
    ...
    <title>Contact Form | Creators Menejerlik ve Mail Üyelik Sistemine Hoşgeldiniz </title>
...
?>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="contact-us layout-top-spacing">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3131.220128539919!2d29.065260549380646!3d40.24027954011271!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14ca403e6298ca49%3A0xd68d4328a4fb7e8e!2zWcSwxJ7EsFQ!5e0!3m2!1str!2str!4v1624871989242!5m2!1str!2str" width="900" height="900" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        <div class="contact-form">
                            <form class="" action="./netting/islem.php"  enctype="multipart/form-data" method="POST" >
                                <div class="cu-section-header">
                                    <h4>İletişime Geçin</h4>
                                    <p>Bizimle iletişime geçerek bizimle görüşlerinizi paylaşabilir, sorularınızı bize danışabilirsiniz.</p>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12 input-fields mb-4 mb-sm-0">
                                        ...
                                        <input type="text" name="contact_name" class="form-control" placeholder="İsim">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12 input-fields">
                                        ...
                                        <input type="text" name="contact_phone" class="form-control" placeholder="Telefon">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12">
                                        <p class="">Seçiceğiniz iletişim şekli:</p>
                                    </div>
                                    <div class="col-sm-12 col-12 input-fields">
                                        <div class="n-chk">
                                            <label class="new-control new-radio radio-success">
                                            <input type="radio" class="new-control-input" name="custom-radio-0" >
                                        ...
                                        <div class="n-chk">
                                            ...
                                            <span class="new-control-indicator"></span>Telefon
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group input-fields">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                            <textarea name="contact_mesaj" class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Mesajınız"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col text-sm-left text-center">
                                        <button type="submit" name="contactkayıt" class="btn btn-primary mt-4">Gönder</button>
                                    </div>
                                </div>
                            </form>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC99WDD-7XSpRAKz0BqU9UmtVP7PonZODk&amp;callback=initMap" async defer></script>
